   ...
   $tot=$_COOKIE["total"]; $link=@mysqli_connect("localhost","root","","quikchef") or die("Erro:Unable to connect: " . mysqli_connect_error());
    ...
    if($result5=mysqli_query($link,$sql5)){
        ...
        $row5=mysqli_fetch_array($result5,MYSQLI_ASSOC);
         ...
         echo '<p id="title">Woodfire Pizza</p>';
      $sql="select item_id,iname,price from menu where rest_id=102";
    ...
    <form name="myForm" method="post" action="wp.php" >
         <?php
        ...
        <br />
        <div class="form-group">
            <input type="submit" name="add" class="btn btn-success btn-lg" id="button1" value="ADD" style="background-color:#04a301;"></div>
        <div class="form-group">
            <input type="submit" name="cont" class="btn btn-success btn-lg" id="button1" value="PROCEED" style="background-color:#04a301;"></div>
        </form>
    </div>    
